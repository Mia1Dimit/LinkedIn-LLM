...
from enrichment.common import snapshot_rows, slugify_text, file_has_content, parse_date, load_enrichment_config
from enrichment.skip_list import SKIP_COMPANIES
from datetime import datetime

# Load config to get start_date
...
for row in rows:
    ...
    # Keep most recent follow date for duplicates
...
for company in companies:
    output_path = output_dir / f"Company_{slugify_text(company['organization'])}.md"
